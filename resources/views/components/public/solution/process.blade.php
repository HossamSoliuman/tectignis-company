        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 svc-process__intro wow move-up">
                    ...
                    <p class="svc-process__lead">A proven, step-by-step approach to ensure a successful rollout — so you always know exactly what happens next.</p>
                    <a href="{{ route('contact') }}" class="svc-btn svc-btn--primary">Get Started</a>
                </div>
