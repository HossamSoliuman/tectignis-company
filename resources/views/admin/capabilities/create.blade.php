...
@section('content')
    ...
    <form action="{{ route('admin.capabilities.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="grid grid-cols-1 xl:grid-cols-[1fr_18rem] gap-6 items-start">
            ...
            <div class="space-y-4 xl:sticky xl:top-20 self-start">
                <div class="rounded-xl border border-slate-200 bg-white p-5 space-y-5">
                    ...
                    <x-admin.image-field name="icon" label="Icon Image" :current="null" />
                    <x-admin.image-field name="banner_image" label="Banner Image" :current="null" />
                    <div>
