...
it('groups the services index by the three categories', function () {
    Service::factory()->create(['is_active' => true, 'category' => 'software_development', 'title' => 'A Software Service']);
    Service::factory()->create(['is_active' => true, 'category' => 'ai_automation', 'title' => 'An AI Service']);
    Service::factory()->create(['is_active' => true, 'category' => 'business_application', 'title' => 'A Business Service']);
