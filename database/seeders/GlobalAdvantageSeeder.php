...
class GlobalAdvantageSeeder extends Seeder
{
    public function run(): void
    {
        $advantages = [
            ...
            [
                ...
                'description' => 'Following global security standards',
                'tone' => 'indigo',
            ...
            [
                ...
                'description' => 'Faster solutions, better results',
                'tone' => 'rose',
        ...
        foreach ($advantages as $index => $advantage) {
            GlobalAdvantage::updateOrCreate(
                ['title' => $advantage['title']],
                array_merge($advantage, ['sort_order' => $index + 1, 'is_active' => true]),
            );
        }
    }
}
