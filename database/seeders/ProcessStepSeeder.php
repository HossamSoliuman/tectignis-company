...
class ProcessStepSeeder extends Seeder
{
    public function run(): void
    {
        $steps = [
            ...
            [
                'title' => 'Grow Together',
                'description' => 'We help you scale and achieve more',
        ...
        foreach ($steps as $index => $step) {
            ProcessStep::updateOrCreate(
                ['title' => $step['title']],
                array_merge($step, ['sort_order' => $index + 1, 'is_active' => true]),
            );
        }
    }
}
