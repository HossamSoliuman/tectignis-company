...
/**
 * Normalizes the structured `content` payload coming from the service admin
 ...
 */
trait ManagesServiceContent
{
    /** Sections that carry an on/off visibility toggle. */
    private const CONTENT_TOGGLES = [
        'features_strip', 'sub_services', 'process', 'tech',
        'industries', 'case_studies', 'why_choose', 'faq', 'cta_band',
    ];
     ...
     */
    protected function prepareContent(Request $request, array &$data, ?Service $service = null): void
    {
